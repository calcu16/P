...
Expression::names_t         Expression::names           = {"Ident", "Int", "UnaryExpr", "BinaryExpr", "Call", "Index"};
...
Index::names_t              Index::names                = {"Value", "Index"};
...
Statement::names_t          Statement::names            = {"Simple", "Return", "Declarations", "If", "For", "Block"};
ForLoop::names_t            ForLoop::names              = {"Init", "Cond", "Inc", "Body"};
If::names_t                 If::names                   = {"Cond", "Body"};
Parameter::names_t          Parameter::names            = {"Const", "Type", "Name"};
